...
class SatelliteAgents:
    ...
    def earth_observation_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                ...
                Please don't pay attention to all information except the ground conditions.
                """),
            verbose=True,
            llm=self.model,
            memory=True,
    ...
    def weather_monitoring_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                ...
                Please don't pay attention to all information except the weather changes.
                """),
            verbose=True,
            llm=self.model,
            memory=True,
    ...
    def communication_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                ...
                Please don't pay attention to all information except the communication status.
                """),
            verbose=True,
            llm=self.model,
            memory=True,
    ...
    def navigation_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                ...
                Please don't pay attention to all information except the navigation status.
                """),
            verbose=True,
            llm=self.model,
            memory=True,
    ...
    def recorder_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                Attention! A major natural disaster is currently occurring!
                As a conscientious Post-disaster Recorder, you will receive real-time reports from each Satellite and The Conductor Agent.
    ...
    def collator_agent(self):
        return Agent(
            ...
            backstory=dedent("""
                ...
                You pay great attention to the logical relationship of events and the specification of text format.
                Please receive the Recorder's report and write it in chronological order referring to the report from the front line.
                """),
            verbose=True,
            llm=self.model,
            memory=True,
